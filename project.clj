(defproject chromex-scittle "0.1.0-SNAPSHOT"
  :dependencies [[org.clojure/clojure "1.10.1"]
                 ...
                 [io.github.babashka/sci.nrepl "0.0.2"]
                 ]
  ;; :git-dependencies [["https://github.com/babashka/sci"
  ;;                     "bf6a0f1e00313a902c62c59e440266612725b926"]]
                          ...
                          {:background
                           {:source-paths ["src/background"
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/background/main.js"
                                           ...
                                           :main          chromex-scittle.background
                                           :optimizations :none
                                           :source-map    true}}
                           :popup
                          ...
                          {:content-script
                           {:source-paths ["src/content_script"
                            ...
                            :compiler     {:output-to     "resources/unpacked/compiled/content-script/main.js"
                                           ...
                                           :main          chromex-scittle.content-script
